...
$_channel_id = isset($_GET['channel_id']) ? $_GET['channel_id'] : '0';
...
$sql = " SELECT t.*,
	...
	channel_tags AS s on t.tag_id = s.tag_id AND s.channel_id = '{$_channel_id}'
	WHERE tag_type_id = 1
...
$sql = "SELECT
		...
		LEFT OUTER JOIN
		channel_tags AS s on f.tag_id = s.tag_id AND s.channel_id = '{$_channel_id}'
