<table id="formTable" >
<form enctype="multipart/form-data"  action="/?a=channels.program_submit&channel_id=<?= $_REQUEST['channel_id'] ?>" method="post" name="form_edit" >	
<input type="hidden" name="_program_id" value="<?= $_program_id ?>" />
